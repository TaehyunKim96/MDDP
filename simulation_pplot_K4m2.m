...
for ip = 1:5
    ...
    %tau = 20; sigma = 1; m = 1;
    tau = 20; sigma1 = 2; sigma2 = 1; m = 2;
    u1 = ones(1, p); u2 = [ones(1, p/4), -ones(1, p/4), ones(1, p/4), -ones(1, p/4)];
    ...
    Sigma = tau * eye(p) + sigma1 * u1.' * u1 + sigma2 * u2.' * u2;
...
print('-dpng', ['images/simulation_pplot_revision_K4m2.png'])